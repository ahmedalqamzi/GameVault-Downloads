...
3. Install [Node.js 22 or newer](https://nodejs.org/) and create a free [Cloudflare account](https://dash.cloudflare.com/sign-up). One [Steam Web API key](https://steamcommunity.com/dev/apikey) is optional unless you want Steam activity import; individual phone users never need a key.
