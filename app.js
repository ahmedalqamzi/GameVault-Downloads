...
if (isIOS) {
  ...
  smartDownload = "https://github.com/ahmedalqamzi/GameVault-Downloads/releases/download/v0.8.0/GameVault-0.8.0-windows-x64-setup.exe";
  smartLabel = "Download for Windows";
} else if (isMac) {
  smartDownload = "https://github.com/ahmedalqamzi/GameVault-Downloads/releases/download/v0.8.0/GameVault-0.8.0-mac-arm64.dmg";
  smartLabel = "Download for macOS";
} else if (isLinux) {
  smartDownload = "https://github.com/ahmedalqamzi/GameVault-Downloads/releases/download/v0.8.0/GameVault-0.8.0-linux-x86_64.AppImage";
